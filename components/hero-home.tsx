    ...
    <section>
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <div className="py-12 md:py-20">
          ...
          <h3
            className="flex items-baseline justify-center animate-[gradient_6s_linear_infinite] bg-[linear-gradient(to_right,var(--color-gray-200),var(--color-indigo-200),var(--color-gray-50),var(--color-indigo-300),var(--color-gray-200))] bg-[length:200%_auto] bg-clip-text pb-5 font-roboto text-2xl font-semibold text-transparent md:text-5xl"
            data-aos="fade-up"
          >
            transparência em <p className="ml-2 font-bold italic">movimento</p>
            </h3>
                ...
                <div data-aos="fade-up" data-aos-delay={400}>
                  ...
                  >
                    <span className="relative inline-flex items-center">
                       Por que a <strong className="ml-1">zylogi ?</strong>
